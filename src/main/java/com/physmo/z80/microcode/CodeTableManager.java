...
public class CodeTableManager {
    ...
    public void initCodeTableFD() {
        ...
        codeTableFD.define(0x35, "dec (iy+d)", MicroOp.FETCH_pIY_D, MicroOp.DEC_8, MicroOp.STORE_pIY_D);
    ...
    public void initCodeTableED() {
        ...
        codeTableED.define(0x43, "ld (nn),bc", MicroOp.FETCH_16_ADDRESS, MicroOp.FETCH_BC, MicroOp.STORE_BYTE_AT_ADDRESS);
        codeTableED.define(0x52, "sbc hl,de", MicroOp.FETCH_DE, MicroOp.SBC_HL);
        codeTableED.define(0x53, "ld (nn),de", MicroOp.FETCH_16_ADDRESS, MicroOp.FETCH_DE, MicroOp.STORE_BYTE_AT_ADDRESS);
    ...
    public void initCodeTableMain() {
        ...
        codeTableMain.define(0x07, "RLCA", MicroOp.RLCA); // 8-bit rotation left
        codeTableMain.define(0x08, "LD (a16),SP", MicroOp.FETCH_SP, MicroOp.FETCH_16_ADDRESS, MicroOp.STORE_p16WORD);
        ...
        codeTableMain.define(0x0F, "RRCA", MicroOp.RRCA);

        codeTableMain.define(0x10, "STOP", MicroOp.STOP);
        ...
        codeTableMain.define(0x1F, "RRA", MicroOp.RRA);
        ...
        codeTableMain.define(0x22, "LD (HL+),A", MicroOp.FETCH_A, MicroOp.SET_ADDR_FROM_HL_INC, MicroOp.STORE_BYTE_AT_ADDRESS);
        ...
        codeTableMain.define(0x2A, "LD A,(HL)", MicroOp.SET_ADDR_FROM_HL_INC, MicroOp.FETCH_BYTE_FROM_ADDR, MicroOp.STORE_A);
        ...
        codeTableMain.define(0x32, "LD (HL-),A", MicroOp.FETCH_A, MicroOp.SET_ADDR_FROM_HL_DEC, MicroOp.STORE_BYTE_AT_ADDRESS);
        ...
        codeTableMain.define(0x3A, "LD A,(HL-)", MicroOp.SET_ADDR_FROM_HL_DEC, MicroOp.FETCH_BYTE_FROM_ADDR, MicroOp.STORE_A);
        ...
        codeTableMain.define(0xC3, "JP a16", MicroOp.FETCH_16_ADDRESS, MicroOp.JP);
        ...
        codeTableMain.define(0xCB, "PREFIX CB", MicroOp.FETCH_8, MicroOp.PREFIX_CB);
        ...
        /* */
        codeTableMain.define(0xD3, "OUT d8,A", MicroOp.FETCH_8_ADDRESS, MicroOp.FETCH_A, MicroOp.OUT); // OUT - working on this
        ...
        codeTableMain.define(0xE0, "LDH (a8),A", MicroOp.FETCH_8, MicroOp.LDZPGA);
        codeTableMain.define(0xE1, "POP HL", MicroOp.POPW, MicroOp.STORE_HL);
        codeTableMain.define(0xE2, "LD (C),A", MicroOp.FETCH_C, MicroOp.LDZPGA);
        codeTableMain.define(0xE3, "NO OP", MicroOp.NOP);
        ...
        codeTableMain.define(0xEA, "LD (a16),A", MicroOp.FETCH_16_ADDRESS, MicroOp.FETCH_A, MicroOp.STORE_BYTE_AT_ADDRESS);
        ...
        codeTableMain.define(0xF0, "LDH A,(a8)", MicroOp.FETCH_8, MicroOp.FETCH_ZPG, MicroOp.STORE_A);  // *
        codeTableMain.define(0xF1, "POP AF", MicroOp.POPW, MicroOp.STORE_AF);
        codeTableMain.define(0xF2, "LD A,(C)", MicroOp.FETCH_C, MicroOp.FETCH_ZPG, MicroOp.STORE_A);
        ...
        codeTableMain.define(0xFA, "LD A,(a16)", MicroOp.FETCH_16_ADDRESS, MicroOp.FETCH_BYTE_FROM_ADDR, MicroOp.STORE_A);
